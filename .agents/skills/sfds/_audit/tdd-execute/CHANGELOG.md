# CHANGELOG — tdd-execute（仲裁版草稿）

## 2026-08-23 · arb-hub 仲裁版草稿 v1

- 底座：zy-ai-consult 版（与 zy-iot-ai 版哈希一致：`4c24a69e1b2d`）。
- 新增 frontmatter `lineage` 血缘头（boxing `28b165989b71` / zy-iot-ai `4c24a69e1b2d` / zy-ai-consult `4c24a69e1b2d`）。
