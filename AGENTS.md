...
| 先记下来、**记一下这个想法**、先放着、暂存、记到待办、**这个需求先不急**、中远期、回顾下待办、**看看哪些能拎起来**、哪条该做、梳理下待办、**细化一下这个需求**、纳入方法论、**从 XX 需求开始设计**、**从头开始迭代设计**、**requirements backlog**、**backlog review** | `requirements-backlog` | 基础 | 需求积压/中远期暂存机制 |
